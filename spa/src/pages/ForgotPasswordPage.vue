<template>
  <div class="flex-1 pt-5" align="center">
    ...
    <div class="flex w-full flex-row items-center">
      <div style="width: 100px" class="text-center self-start"></div>
      <div style="width: 120px" class="text-left"></div>
      <div class="flex-1 px-8">
        <h2 class="mb-2">Forgot Password</h2>

        <p class="mb-2">
          Enter your account's email address to receive instructions to reset
          your password.
        </p>
        <br />
        ...
        <tbody>
          ...
          <tr align="center">
            <td align="center" colspan="2">
              <button type="button" tabindex="3" class="btn" @click="reset">
                Request Reset Link
              </button>
            </td>
          </tr>
      ...
      <div style="width: 120px" class="text-right"></div>
      <div class="text-center self-start" style="width: 100px"></div>
    </div>
